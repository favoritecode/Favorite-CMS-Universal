...
├── public/               # Public webroot (index.php, static assets, uploads)
├── resources/views/      # System views, fallback frontend templates, installer, and admin panel
├── scripts/              # Packaging and migration runner scripts
├── storage/              # Cache, logs, sessions, backups, temp, and installed.lock
└── tests/                # Automated PHPUnit integration and unit test suite
```

> **Note on Ecosystem Separation**: Official themes (e.g., *Favorite Web*) and plugins (e.g., *Favorite Pay*, *Favorite Digital*, *Favorite Multimedia*) are decoupled from the Core repository and maintained independently at [Favorite-CMS-Assets](https://github.com/favoritecode/Favorite-CMS-Assets). The Core provides native extension managers and update discovery to install and manage external themes and plugins dynamically.
...
Favorite CMS Universal includes a comprehensive PHPUnit test suite validating critical paths including database migrations, installer persistence, upload limits, sanitization, user moderation, role permission matrix, core update lifecycle, and customizer contracts.
...
Pre-built production ZIP packages are released via the official [GitHub Releases](https://github.com/favoritecode/Favorite-CMS-Universal/releases) page. Production packages contain pure Core application files ready for immediate unzipping and browser setup.

- **Current Release Line**: `v1.0.0 Stable`
- **Release Package**: `Favorite-CMS-Universal-v1.0.0.zip`
- **Official Extensions**: [Favorite-CMS-Assets](https://github.com/favoritecode/Favorite-CMS-Assets)
