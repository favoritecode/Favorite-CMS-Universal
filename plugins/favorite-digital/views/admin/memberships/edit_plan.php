...
<div class="fd-admin-wrap" style="max-width: 860px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
    <div style="margin-bottom: 20px;">
        ...
        <h2 style="font-size: 22px; font-weight: 600; color: #1e1e1e; margin: 8px 0 4px 0;">
            Edit Membership Tier: <?php echo htmlspecialchars($product->title, ENT_QUOTES, 'UTF-8'); ?>
        </h2>
        <p style="color: #646970; font-size: 13px; margin: 0;">Update plan details, pricing, and duration rules.</p>
    </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <div style="background: #fff; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px; box-shadow: 0 1px 1px rgba(0,0,0,0.04);">
                ...
                <div style="margin-bottom: 16px;">
                    ...
                    <input type="text" name="title" required value="<?php echo htmlspecialchars((string)($old['title'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" style="width: 100%; box-sizing: border-box; padding: 8px 12px; border: 1px solid #8c8f94; border-radius: 4px; font-size: 14px;">
                </div>
                ...
                <div style="margin-bottom: 16px;">
                    ...
                    <input type="text" name="slug" value="<?php echo htmlspecialchars((string)($old['slug'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" style="width: 100%; box-sizing: border-box; padding: 8px 12px; border: 1px solid #8c8f94; border-radius: 4px; font-size: 13px; font-family: monospace;">
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" style="width: 100%; box-sizing: border-box; padding: 8px 12px; border: 1px solid #8c8f94; border-radius: 4px; font-size: 13px; font-family: inherit;"><?php echo htmlspecialchars((string)($old['description'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></textarea>
                </div>
            </div>
            ...
            <div style="background: #fff; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px; box-shadow: 0 1px 1px rgba(0,0,0,0.04);">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                    <div>
                        ...
                        <select name="plan_type" style="width: 100%; box-sizing: border-box; padding: 8px 12px; border: 1px solid #8c8f94; border-radius: 4px; font-size: 13px;">
                            <option value="monthly" <?php echo (($old['plan_type'] ?? '') === 'monthly') ? 'selected' : ''; ?>>Monthly (1 Calendar Month)</option>
                    ...
                    <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer; font-size: 13px; color: #1e1e1e;">
                        ...
                        <div>
                            ...
                            <div style="color: #646970; font-size: 12px; margin-top: 2px;">
                                Permit customers to opt in to recurring auto-renewal.
                            </div>
                        </div>
                    </label>
                </div>
            ...
            <div style="background: #fff; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px; box-shadow: 0 1px 1px rgba(0,0,0,0.04);">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="original_price" value="<?php echo htmlspecialchars((string)($old['original_price'] ?? '0.00'), ENT_QUOTES, 'UTF-8'); ?>" style="width: 100%; box-sizing: border-box; padding: 8px 12px; border: 1px solid #8c8f94; border-radius: 4px; font-size: 13px;">
                    </div>
                    <div>
                        <label style="display: block; font-weight: 600; font-size: 13px; margin-bottom: 6px; color: #1e1e1e;">
                            Discount (%)
            ...
            <div style="display: flex; justify-content: flex-end; gap: 12px;">
                ...
                <button type="submit" style="padding: 9px 24px; background: #2271b1; color: #fff; border: none; border-radius: 4px; cursor: pointer; font-weight: 600; font-size: 13px;">Save Changes</button>
            </div>
        </div>
    </form>
</div>
