        ...
        <nav class="wp-sidebar">
            <ul class="wp-menu">
                <li class="wp-menu-item <?php echo $activeMenu === 'dashboard' ? 'active' : ''; ?>">
                    <a href="<?php echo htmlspecialchars(site_path('/admin'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link">📊 Dashboard</a>
                </li>
                <?php
                ...
                <?php if ($isAdmin): ?>
                    <li class="wp-menu-item <?php echo $activeMenu === 'updates' ? 'active' : ''; ?>">
                        <a href="<?php echo htmlspecialchars(site_path('/admin/updates'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link">🔄 Updates</a>
                    </li>
                <?php endif; ?>
                <?php
                ...
                <li class="wp-menu-item has-submenu <?php echo $isPostsActive ? 'active is-expanded' : ''; ?>">
                    <a href="<?php echo htmlspecialchars(site_path('/admin/posts'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link" aria-haspopup="true" aria-expanded="<?php echo $isPostsActive ? 'true' : 'false'; ?>" aria-controls="submenu-posts">
                        <span>📝 Posts</span>
                    ...
                    <ul class="wp-submenu" id="submenu-posts">
                        <li><a href="<?php echo htmlspecialchars(site_path('/admin/posts'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'posts' ? 'active' : ''; ?>">All Posts</a></li>
                        <?php if ($canCreatePosts): ?>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/posts/new'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'posts-new' ? 'active' : ''; ?>">Add New Post</a></li>
                        <?php endif; ?>
                        <?php if ($canModerate): ?>
                            <li>
                                <a href="<?php echo htmlspecialchars(site_path('/admin/posts?status=pending'), ENT_QUOTES, 'UTF-8'); ?>" style="<?php echo $pendingCount > 0 ? 'font-weight: 700; color: #e5a00d;' : ''; ?>">
                                    Pending Review <?php echo $pendingCount > 0 ? "({$pendingCount})" : ''; ?>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if ($canManageTaxonomies): ?>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/taxonomies/categories'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'categories' ? 'active' : ''; ?>">Categories</a></li>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/taxonomies/tags'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'tags' ? 'active' : ''; ?>">Tags</a></li>
                        <?php endif; ?>
                    </ul>
                </li>
                <?php endif; ?>
                ...
                <li class="wp-menu-item has-submenu <?php echo $isPagesActive ? 'active is-expanded' : ''; ?>">
                    <a href="<?php echo htmlspecialchars(site_path('/admin/pages'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link" aria-haspopup="true" aria-expanded="<?php echo $isPagesActive ? 'true' : 'false'; ?>" aria-controls="submenu-pages">
                        <span>📄 Pages</span>
                        <span class="wp-menu-toggle-icon" aria-hidden="true">
                            <svg width="12" height="12" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                        </span>
                    ...
                    <ul class="wp-submenu" id="submenu-pages">
                        <li><a href="<?php echo htmlspecialchars(site_path('/admin/pages'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'pages' ? 'active' : ''; ?>">All Pages</a></li>
                        <li><a href="<?php echo htmlspecialchars(site_path('/admin/pages/new'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'pages-new' ? 'active' : ''; ?>">Add New Page</a></li>
                    </ul>
                </li>
                <?php endif; ?>
                <?php if ($canManageMedia): ?>
                <li class="wp-menu-item <?php echo $activeMenu === 'media' ? 'active' : ''; ?>">
                    <a href="<?php echo htmlspecialchars(site_path('/admin/media'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link">🖼️ Media</a>
                </li>
                <?php endif; ?>
                <?php if ($canModerateComments): ?>
                    <li class="wp-menu-item <?php echo $activeMenu === 'comments' ? 'active' : ''; ?>">
                        <a href="<?php echo htmlspecialchars(site_path('/admin/comments'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link">
                            💬 Comments
                ...
                <?php if ($isAdmin): ?>
                    ...
                    <li class="wp-menu-item has-submenu <?php echo $isThemesActive ? 'active is-expanded' : ''; ?>">
                        <a href="<?php echo htmlspecialchars(site_path('/admin/themes'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link" aria-haspopup="true" aria-expanded="<?php echo $isThemesActive ? 'true' : 'false'; ?>" aria-controls="submenu-themes">
                        ...
                        <ul class="wp-submenu" id="submenu-themes">
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/themes'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'themes' ? 'active' : ''; ?>">Themes</a></li>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/customize'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'customize' ? 'active' : ''; ?>">Customize</a></li>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/widgets'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'widgets' ? 'active' : ''; ?>">Widgets</a></li>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/menus'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'menus' ? 'active' : ''; ?>">Menus</a></li>
                        </ul>
                    </li>
                    <li class="wp-menu-item <?php echo $activeMenu === 'plugins' ? 'active' : ''; ?>">
                        <a href="<?php echo htmlspecialchars(site_path('/admin/plugins'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link">🔌 Plugins</a>
                    </li>
                <?php elseif ($canManageMenus): ?>
                    <li class="wp-menu-item <?php echo $activeMenu === 'menus' ? 'active' : ''; ?>">
                        <a href="<?php echo htmlspecialchars(site_path('/admin/menus'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link">🎨 Menus</a>
                    </li>
                <?php endif; ?>
                ...
                <li class="wp-menu-item has-submenu <?php echo $isUsersActive ? 'active is-expanded' : ''; ?>">
                    <a href="<?php echo htmlspecialchars(site_path($canManageUsers ? '/admin/users' : '/admin/users/profile'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link" aria-haspopup="true" aria-expanded="<?php echo $isUsersActive ? 'true' : 'false'; ?>" aria-controls="submenu-users">
                        <span>👥 Users</span>
                        <span class="wp-menu-toggle-icon" aria-hidden="true">
                            <svg width="12" height="12" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                        </span>
                    ...
                    <ul class="wp-submenu" id="submenu-users">
                        <?php if ($canManageUsers): ?>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/users'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'users' ? 'active' : ''; ?>">All Users</a></li>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/users/new'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'users-new' ? 'active' : ''; ?>">Add New</a></li>
                        <?php endif; ?>
                        <li><a href="<?php echo htmlspecialchars(site_path('/admin/users/profile'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'profile' ? 'active' : ''; ?>">Profile</a></li>
                    </ul>
                </li>

                <?php if ($isAdmin): ?>
                    <li class="wp-menu-item <?php echo $activeMenu === 'settings' ? 'active' : ''; ?>">
                        <a href="<?php echo htmlspecialchars(site_path('/admin/settings'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link">⚙️ Settings</a>
                    </li>
                    <li class="wp-menu-item <?php echo $activeMenu === 'seo' ? 'active' : ''; ?>">
                        <a href="<?php echo htmlspecialchars(site_path('/admin/seo'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link">🔍 SEO</a>
                    </li>
                    <?php
                    ...
                    <li class="wp-menu-item has-submenu <?php echo $isToolsActive ? 'active is-expanded' : ''; ?>">
                        <a href="<?php echo htmlspecialchars(site_path('/admin/tools'), ENT_QUOTES, 'UTF-8'); ?>" class="wp-menu-link" aria-haspopup="true" aria-expanded="<?php echo $isToolsActive ? 'true' : 'false'; ?>" aria-controls="submenu-tools">
                            <span>🛠️ Tools</span>
                            <span class="wp-menu-toggle-icon" aria-hidden="true">
                                <svg width="12" height="12" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                            </span>
                        ...
                        <ul class="wp-submenu" id="submenu-tools">
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/tools'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'tools' ? 'active' : ''; ?>">Backups &amp; Health</a></li>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/tools/import'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'tools-import' ? 'active' : ''; ?>">Import / Migration</a></li>
                            <li><a href="<?php echo htmlspecialchars(site_path('/admin/updates'), ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === 'updates' ? 'active' : ''; ?>">Core Updates</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                ...
                foreach ($dynamicMenus as $dMenu):
                    ...
                    $menuUrl = htmlspecialchars(site_path('/admin/page/'), ENT_QUOTES, 'UTF-8') . htmlspecialchars($dMenu['slug'], ENT_QUOTES, 'UTF-8');
                        ...
                        <?php if ($hasSub): ?>
                            <ul class="wp-submenu" id="<?php echo $subId; ?>">
                                ...
                                <?php foreach ($dMenu['submenus'] as $sub): ?>
                                    <li><a href="<?php echo htmlspecialchars(site_path('/admin/page/'), ENT_QUOTES, 'UTF-8'); ?><?php echo htmlspecialchars($sub['slug'], ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo $activeMenu === $sub['slug'] ? 'active' : ''; ?>"><?php echo htmlspecialchars($sub['title'], ENT_QUOTES, 'UTF-8'); ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        <?php endif; ?>
                    </li>
