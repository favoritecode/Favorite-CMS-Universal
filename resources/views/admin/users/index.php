<div class="page-header">
    ...
    <a href="<?php echo htmlspecialchars(site_path('/admin/users/new'), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary">Add New User</a>
</div>

<form method="POST" action="<?php echo htmlspecialchars(site_path('/admin/users/bulk'), ENT_QUOTES, 'UTF-8'); ?>" id="users-bulk-form">
            ...
            <tbody>
                ...
                <?php foreach ($users as $u): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong>
                                <a href="<?php echo htmlspecialchars(site_path('/admin/users/edit?id='), ENT_QUOTES, 'UTF-8'); ?><?php echo (int)$u->id; ?>" class="row-title">
