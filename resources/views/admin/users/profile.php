...
<div style="display: grid; grid-template-columns: minmax(280px, 340px) 1fr; gap: 24px; align-items: start;">
    ...
    <div class="card" style="margin-bottom: 0;">
        ...
        <div class="card-body" style="text-align: center;">
            ...
            <!-- Avatar Upload Form -->
            <form method="POST" action="<?php echo htmlspecialchars(site_path('/admin/users/profile/update'), ENT_QUOTES, 'UTF-8'); ?>" enctype="multipart/form-data" style="margin-bottom: 16px; text-align: left;">
                <input type="hidden" name="_token" value="<?php echo htmlspecialchars($token, ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <form method="POST" action="<?php echo htmlspecialchars(site_path('/admin/users/profile/update'), ENT_QUOTES, 'UTF-8'); ?>" style="margin-bottom: 16px; text-align: left;">
                <input type="hidden" name="_token" value="<?php echo htmlspecialchars($token, ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <?php if (!empty($user->avatar)): ?>
                <form method="POST" action="<?php echo htmlspecialchars(site_path('/admin/users/profile/update'), ENT_QUOTES, 'UTF-8'); ?>">
                    <input type="hidden" name="_token" value="<?php echo htmlspecialchars($token, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <div class="card" style="margin-bottom: 0;">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo htmlspecialchars(site_path('/admin/users/profile/update'), ENT_QUOTES, 'UTF-8'); ?>" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="<?php echo htmlspecialchars($token, ENT_QUOTES, 'UTF-8'); ?>">
...
<div class="card" style="margin-top: 24px; border: 1px solid #fca5a5; background: #fff;">
    ...
    <div class="card-body">
        ...
        <?php else: ?>
            ...
            <form method="POST" action="<?php echo htmlspecialchars(site_path('/admin/users/profile/delete-account'), ENT_QUOTES, 'UTF-8'); ?>" onsubmit="return confirm('Are you sure you want to permanently delete your account? This action cannot be undone.');" style="max-width: 480px;">
                <input type="hidden" name="_token" value="<?php echo htmlspecialchars($token, ENT_QUOTES, 'UTF-8'); ?>">
