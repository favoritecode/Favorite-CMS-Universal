    ...
    <table class="wp-table">
        ...
        <tbody>
            <?php if (empty($plugins)): ?>
                <tr>
                    <td colspan="3" style="text-align: center; color: var(--wp-text-muted); padding: 24px;">No plugins installed.</td>
                </tr>
            <?php else: ?>
                <?php foreach ($plugins as $id => $plugin): ?>
                    <tr style="background: <?php echo $plugin['active'] ? '#f0f6fc' : '#ffffff'; ?>;">
                        <td>
