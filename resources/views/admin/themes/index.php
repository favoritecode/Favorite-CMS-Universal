...
<div class="form-card" style="margin-bottom: 24px; padding: 20px;">
    ...
    <form method="POST" action="<?php echo htmlspecialchars(site_path('/admin/themes/upload'), ENT_QUOTES, 'UTF-8'); ?>" enctype="multipart/form-data" style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
